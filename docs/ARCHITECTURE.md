...
see [`docs/PHASE_L_PROGRESS.md`](PHASE_L_PROGRESS.md) for the
historical record).
...
[`docs/ROADMAP_DECISIONS.md` § "Binary-compatible varlena layout"](ROADMAP_DECISIONS.md).
...
[`docs/PHASE19_PROGRESS.md`](PHASE19_PROGRESS.md) enumerates the
...
[`docs/ROADMAP_DECISIONS.md`](ROADMAP_DECISIONS.md). Today's
...
- Unlogged indexes ship with a populated `INIT_FORKNUM`
  ([`docs/PHASE_L_PROGRESS.md`](PHASE_L_PROGRESS.md) item 2)
...
- **Phases 17–21** (v1.0.0-rc.1 → v1.0.0): release-candidate
  ...
  varlena handoff (deferred per ROADMAP_DECISIONS), forced-index
...
- **v1.3.0** — **Phase Q**: side-table storage retired. The
  ...
  `REINDEX`. See [`docs/PHASE_L_PROGRESS.md`](PHASE_L_PROGRESS.md)
