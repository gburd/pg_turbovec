...
`docs/COMPETITIVE_ANALYSIS.md` and `docs/PHASE_F_COLBERT_PLAN.md`
...
- `docs/COMPETITIVE_ANALYSIS.md`: refreshed v1.10.1/v1.11.0 →
...
(`docs/ROADMAP_BEAT_COMPETITORS.md` Phase B-1/B-2).
...
(`docs/ROADMAP_BEAT_COMPETITORS.md` Phase B-4).
