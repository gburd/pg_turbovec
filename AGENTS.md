...
### Current (as of v1.15.1, 2026-06-17)

| From               | To       | Action            |
|--------------------|----------|-------------------|
| 1.0.x / 1.1.x      | 1.15.1   | `REINDEX INDEX` once |
| 1.2.x              | 1.15.1   | `REINDEX INDEX` once |
| 1.3.x              | 1.15.1   | `REINDEX INDEX` once (rotation matrix migration) |
| 1.4.x → 1.15.x     | 1.15.1   | `ALTER EXTENSION pg_turbovec UPDATE` only |
